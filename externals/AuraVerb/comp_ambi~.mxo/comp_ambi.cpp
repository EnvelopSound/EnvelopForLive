...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider1 = FAUSTFLOAT(-30.0);
		fHslider2 = FAUSTFLOAT(50.0);
		fHslider3 = FAUSTFLOAT(500.0);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("comp_ambi");
		ui_interface->declare(&fHslider2, "scale", "log");
		ui_interface->declare(&fHslider2, "style", "knob");
		ui_interface->declare(&fHslider2, "unit", "ms");
		ui_interface->addHorizontalSlider("Attack", &fHslider2, 50.0, 1.0, 1000.0, 0.10000000000000001);
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->addHorizontalSlider("Ratio", &fHslider0, 5.0, 1.0, 20.0, 0.10000000000000001);
		ui_interface->declare(&fHslider3, "scale", "log");
		ui_interface->declare(&fHslider3, "style", "knob");
		ui_interface->declare(&fHslider3, "unit", "ms");
		ui_interface->addHorizontalSlider("Release", &fHslider3, 500.0, 1.0, 1000.0, 0.10000000000000001);
		ui_interface->declare(&fHslider1, "style", "knob");
		ui_interface->declare(&fHslider1, "unit", "dB");
		ui_interface->addHorizontalSlider("Threshold", &fHslider1, -30.0, -100.0, 10.0, 0.10000000000000001);
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		double fSlow0 = (1.0 / double(fHslider0));
		double fSlow1 = double(fHslider1);
		double fSlow2 = (0.025000000000000001 * ((1.0 - fSlow0) / pow(10.0, (0.050000000000000003 * fSlow1))));
		double fSlow3 = max(fConst1, (0.001 * double(fHslider2)));
		double fSlow4 = (((0.5 * fSlow3) > 0.0)?exp((0.0 - (fConst2 / fSlow3))):0.0);
		double fSlow5 = (fSlow0 + -1.0);
		double fSlow6 = ((fSlow3 > 0.0)?exp((0.0 - (fConst1 / fSlow3))):0.0);
		double fSlow7 = max(fConst1, (0.001 * double(fHslider3)));
		double fSlow8 = ((fSlow7 > 0.0)?exp((0.0 - (fConst1 / fSlow7))):0.0);
		double fSlow9 = (1.0 - fSlow8);
		double fSlow10 = (1.0 - fSlow6);
		double fSlow11 = (1.0 - fSlow4);
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec2[0] = ((max(fTemp4, fRec2[1]) * fSlow8) + (fTemp4 * fSlow9));
			fRec1[0] = ((fSlow6 * fRec1[1]) + (fRec2[0] * fSlow10));
			fRec0[0] = ((fSlow4 * fRec0[1]) + (fSlow5 * (max(((20.0 * log10(fRec1[0])) - fSlow1), 0.0) * fSlow11)));
			double fTemp5 = pow(10.0, (fSlow2 * fRec0[0]));
			output0[i] = FAUSTFLOAT(fTemp5);
			output1[i] = FAUSTFLOAT((fTemp0 * fTemp5));
			output2[i] = FAUSTFLOAT((fTemp1 * fTemp5));
			output3[i] = FAUSTFLOAT((fTemp2 * fTemp5));
			output4[i] = FAUSTFLOAT((fTemp3 * fTemp5));
			fRec2[1] = fRec2[0];
			fRec1[1] = fRec1[0];
			fRec0[1] = fRec0[0];
