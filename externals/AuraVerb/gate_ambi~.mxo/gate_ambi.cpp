...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider2 = FAUSTFLOAT(-30.0);
		fHslider3 = FAUSTFLOAT(200.0);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("gate_ambi");
		ui_interface->declare(&fHslider0, "scale", "log");
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->declare(&fHslider0, "unit", "us");
		ui_interface->addHorizontalSlider("Attack", &fHslider0, 10.0, 10.0, 10000.0, 1.0);
		ui_interface->declare(&fHslider3, "scale", "log");
		ui_interface->declare(&fHslider3, "style", "knob");
		ui_interface->declare(&fHslider3, "unit", "ms");
		ui_interface->addHorizontalSlider("Hold", &fHslider3, 200.0, 1.0, 1000.0, 1.0);
		ui_interface->declare(&fHslider1, "scale", "log");
		ui_interface->declare(&fHslider1, "style", "knob");
		ui_interface->declare(&fHslider1, "unit", "ms");
		ui_interface->addHorizontalSlider("Release", &fHslider1, 100.0, 1.0, 1000.0, 1.0);
		ui_interface->declare(&fHslider2, "style", "knob");
		ui_interface->declare(&fHslider2, "unit", "dB");
		ui_interface->addHorizontalSlider("Threshold", &fHslider2, -30.0, -120.0, 0.0, 0.10000000000000001);
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		double fSlow0 = max(fConst1, (9.9999999999999995e-07 * double(fHslider0)));
		double fSlow1 = ((fSlow0 > 0.0)?exp((0.0 - (fConst2 / fSlow0))):0.0);
		double fSlow2 = (((0.5 * fSlow0) > 0.0)?exp((0.0 - (fConst3 / fSlow0))):0.0);
		double fSlow3 = max(fConst1, (0.001 * double(fHslider1)));
		double fSlow4 = (((0.5 * fSlow3) > 0.0)?exp((0.0 - (fConst3 / fSlow3))):0.0);
		double fSlow5 = (1.0 - fSlow4);
		double fSlow6 = (1.0 - fSlow2);
		double fSlow7 = pow(10.0, (0.050000000000000003 * double(fHslider2)));
		int iSlow8 = int((fConst0 * max(fConst1, (0.001 * double(fHslider3)))));
		double fSlow9 = ((fSlow3 > 0.0)?exp((0.0 - (fConst2 / fSlow3))):0.0);
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			double fTemp4 = fabs((((fabs(fTemp0) + fabs(fTemp1)) + fabs(fTemp2)) + fabs(fTemp3)));
			fRec3[0] = ((max(fTemp4, fRec3[1]) * fSlow4) + (fTemp4 * fSlow5));
			fRec2[0] = ((fRec2[1] * fSlow2) + (fRec3[0] * fSlow6));
			int iTemp5 = (fRec2[0] > fSlow7);
			iVec0[0] = iTemp5;
			iRec4[0] = max(int(((iTemp5 > iVec0[1]) & iSlow8)), int((iRec4[1] + -1)));
			double fTemp6 = fabs(max(double(iTemp5), double((iRec4[0] > 0))));
			fRec1[0] = ((max(fTemp6, fRec1[1]) * fSlow9) + (fTemp6 * fSlow10));
			fRec0[0] = ((fRec0[1] * fSlow1) + (fRec1[0] * fSlow11));
			output0[i] = FAUSTFLOAT(fRec0[0]);
			output1[i] = FAUSTFLOAT((fTemp0 * fRec0[0]));
			output2[i] = FAUSTFLOAT((fTemp1 * fRec0[0]));
			output3[i] = FAUSTFLOAT((fTemp2 * fRec0[0]));
			output4[i] = FAUSTFLOAT((fTemp3 * fRec0[0]));
			fRec3[1] = fRec3[0];
			fRec2[1] = fRec2[0];
			iVec0[1] = iVec0[0];
			iRec4[1] = iRec4[0];
