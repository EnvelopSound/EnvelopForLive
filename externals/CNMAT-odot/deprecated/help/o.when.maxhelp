...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 182.0, 406.0, 20.0 ],
					"text" : "o.when behaves like o.if with only the left-most outlet (i.e. the \"then\" outlet)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 134.0, 414.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 45.0, 243.0, 87.0 ],
					"text" : "o.when"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-1",
					"items" : [ "o.if", ",", "o.cond", ",", "o.unless", ",", "o.expr", ",", "expr", ",", "jit.expr" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
