...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 411.0, 441.5, 150.0, 34.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 411.0, 223.0, 45.0, 24.0 ],
									"text" : "/i : 9",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "FullPacket" ],
													"patching_rect" : [ 64.5, 100.0, 113.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "FullPacket" ],
													"patching_rect" : [ 64.5, 182.0, 117.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "FullPacket" ],
													"patching_rect" : [ 64.5, 221.0, 61.0, 20.0 ],
													"text" : "o.expr /i--"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 64.5, 141.0, 56.0, 20.0 ],
													"text" : "o.if /i > 0"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 101.5, 325.5, 25.0, 25.0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"disabled" : 0,
													"hidden" : 0,
													"midpoints" : [ 74.0, 263.0, 51.5, 263.0, 51.5, 131.0, 74.0, 131.0 ],
													"source" : [ "obj-5", 0 ]
												}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 695.0, 203.0, 150.0, 20.0 ],
									"text" : "see also:"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "clear" ],
									"patching_rect" : [ 711.5, 24.0, 149.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 46.0, 113.0, 600.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"id" : "obj-13",
									"items" : [ "o.callpatch", ",", "o.mappatch", ",", "o.expr" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 695.0, 225.0, 132.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 695.0, 284.0, 53.0, 20.0 ],
									"text" : "pcontrol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 695.0, 260.0, 138.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 147.0, 441.5, 260.0, 37.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 379.0, 363.0, 169.0, 52.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 273.0, 223.0, 138.0, 24.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "FullPacket" ],
									"patching_rect" : [ 411.0, 334.0, 62.0, 20.0 ],
									"text" : "o.let /i = /i"
								}
