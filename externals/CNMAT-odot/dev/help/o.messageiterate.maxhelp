...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.5, 264.0, 150.0, 37.0 ],
					"text" : "/foo : 10,\n/bar : 1.23",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "clear" ],
					"patching_rect" : [ 452.5, 65.0, 219.0, 20.0 ],
					"text" : "o.helpfilehelper @obj o.messageiterate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 134.0, 203.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 45.0, 563.0, 87.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 71.5, 328.0, 113.5, 20.0 ],
					"text" : "o.righttoleft"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 191.5, 368.0, 83.0, 20.0 ],
					"text" : "o.print bundle"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.5, 400.0, 102.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 71.5, 368.0, 103.0, 20.0 ],
					"text" : "o.messageiterate"
				}
