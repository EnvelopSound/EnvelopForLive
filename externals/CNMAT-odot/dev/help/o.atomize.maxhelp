...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 55.5, 480.0, 140.0, 51.0 ],
									"presentation_rect" : [ 256.0, 553.5, 0.0, 0.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 319.0, 256.0, 60.0, 20.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 155.5, 368.0, 50.0, 20.0 ],
									"text" : "o.union"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 319.0, 295.5, 150.0, 37.0 ],
									"text" : "/mysynth/2/freq : 440,\n/nada : \"rien\"",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "FullPacket" ],
									"patching_rect" : [ 155.5, 304.0, 147.0, 20.0 ],
									"text" : "o.pack /mysynth/2/gain 0."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 422.5, 435.0, 61.0, 20.0 ],
									"text" : "print right"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 289.0, 435.0, 73.0, 20.0 ],
									"text" : "print middle"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 155.5, 435.0, 53.0, 20.0 ],
									"text" : "print left"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "clear" ],
									"patching_rect" : [ 581.0, 261.0, 179.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 167.0, 600.0, 60.0 ],
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"id" : "obj-1",
									"items" : [ "o.route", ",", "o.select", ",", "OSC-route", ",", "OpenSoundControl", ",", "route" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 203.5, 480.0, 280.0, 47.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 55.5, 575.0, 34.0, 20.0 ],
									"text" : "print"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "FullPacket" ],
									"patching_rect" : [ 55.5, 545.0, 61.0, 20.0 ],
									"text" : "o.atomize"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "FullPacket" ],
									"patching_rect" : [ 155.5, 400.0, 286.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 155.5, 256.0, 50.0, 20.0 ]
								}
