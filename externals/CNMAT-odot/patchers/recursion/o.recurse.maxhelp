...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 72.0, 49.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 166.0, 72.0, 49.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 244.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "o.recurse"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 70.0, 186.0, 150.0, 45.0 ],
					"text" : "/result ??= 1,\n /result *= /v--",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 231.0, 234.0, 150.0, 34.0 ],
					"text" : "/result : 120",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 66.0, 38.0, 57.0, 20.0 ],
					"style" : "",
					"text" : "Factorial"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 231.0, 192.0, 88.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 70.0, 138.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "o.if /v > 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 256.0, 412.0, 274.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 72.5, 447.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 72.5, 412.0, 176.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 437.0, 32.0, 61.0, 20.0 ],
					"presentation_rect" : [ 297.0, 110.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "o.recurse"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 437.0, 72.0, 185.0, 194.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 120.5, 167.0, 240.5, 167.0 ],
					"source" : [ "obj-22", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 79.5, 276.0, 56.0, 276.0, 56.0, 133.0, 79.5, 133.0 ],
					"source" : [ "obj-25", 0 ]
				}
