...
#ifndef FAUSTCLASS 
#define FAUSTCLASS hb1_to_binaural
#endif
...
class hb1_to_binaural : public dsp {
 ...
 public:
	...
	virtual hb1_to_binaural* clone() {
		return new hb1_to_binaural();
	}
 ...
 */
class hb1_to_binaural_poly : public dsp_voice_group, public dsp_poly {
    ...
    private:
        ...
        {
            if (val == FAUSTFLOAT(1)) {
                static_cast<hb1_to_binaural_poly*>(arg)->allNotesOff(true);
            }
        }
    ...
    public:
         ...
         * Constructor.
         *
         * @param dsp - the dsp to be used for one voice. Beware: hb1_to_binaural_poly will use and finally delete the pointer.
        ...
        virtual hb1_to_binaural_poly* clone()
        {
            return new hb1_to_binaural_poly(fDSP->clone(), int(fVoiceTable.size()), fVoiceControl, fGroupControl);
        }
...
void faust_allocate(t_faust* x, int nvoices)
{
    ...
    #endif
        x->m_dsp = new hb1_to_binaural_poly(new hb1_to_binaural(), nvoices, true, true);
    #ifdef POLY2
...
void* faust_new(t_symbol* s, short ac, t_atom* av)
{
    ...
    hb1_to_binaural* tmp_dsp = new hb1_to_binaural();
...
#endif
{
    ...
    dsp* tmp_dsp = new hb1_to_binaural();
    mspUI tmp_UI;
