...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "bformat2ambix3");
		m->declare("license", "BSD 3-Clause License");
		m->declare("name", "bformat2ambix3");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("bformat2ambix3");
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			output9[i] = FAUSTFLOAT(0);
			output10[i] = FAUSTFLOAT(0);
			output11[i] = FAUSTFLOAT(0);
			output12[i] = FAUSTFLOAT(0);
			output13[i] = FAUSTFLOAT(0);
			output14[i] = FAUSTFLOAT(0);
			output15[i] = FAUSTFLOAT(0);
