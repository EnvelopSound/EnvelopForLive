...
copyright: "(c) Aaron J. Heller 2014"
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("copyright", "(c) Aaron J. Heller 2014");
		m->declare("filename", "fuma2ambix3");
		m->declare("license", "BSD 3-Clause License");
		m->declare("name", "fuma2ambix3");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("fuma2ambix3");
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			output0[i] = FAUSTFLOAT((1.414213562 * double(input0[i])));
			output1[i] = FAUSTFLOAT(double(input2[i]));
			output2[i] = FAUSTFLOAT(double(input3[i]));
			output3[i] = FAUSTFLOAT(double(input1[i]));
			output4[i] = FAUSTFLOAT((0.86602540380000004 * double(input8[i])));
			output5[i] = FAUSTFLOAT((0.86602540380000004 * double(input6[i])));
			output6[i] = FAUSTFLOAT(double(input4[i]));
			output7[i] = FAUSTFLOAT((0.86602540380000004 * double(input5[i])));
			output8[i] = FAUSTFLOAT((0.86602540380000004 * double(input7[i])));
			output9[i] = FAUSTFLOAT((0.790569415 * double(input15[i])));
			output10[i] = FAUSTFLOAT((0.74535599249999995 * double(input13[i])));
			output11[i] = FAUSTFLOAT((0.84327404269999995 * double(input11[i])));
			output12[i] = FAUSTFLOAT(double(input9[i]));
			output13[i] = FAUSTFLOAT((0.84327404269999995 * double(input10[i])));
			output14[i] = FAUSTFLOAT((0.74535599249999995 * double(input12[i])));
			output15[i] = FAUSTFLOAT((0.790569415 * double(input14[i])));
