...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 444.0, 42.0, 18.0 ],
					"style" : "",
					"text" : "On/Off",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 576.818176, 205.0, 65.0, 18.0 ],
					"style" : "",
					"text" : "Sub Angles"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 389.818176, 205.0, 69.0, 18.0 ],
					"style" : "",
					"text" : "Main Angles",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.818176, 308.0, 68.0, 18.0 ],
					"style" : "",
					"text" : "Sub Decode",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 395.5, 74.0, 18.0 ],
					"style" : "",
					"text" : "Audio Output",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 308.0, 72.0, 18.0 ],
					"style" : "",
					"text" : "Main Decode",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 131.0, 60.0, 18.0 ],
					"style" : "",
					"text" : "Input Gain",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 26.0, 69.0, 18.0 ],
					"style" : "",
					"text" : "AmbiX Input",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 398.818176, 26.0, 69.0, 18.0 ],
					"style" : "",
					"text" : "Initialization"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 96.599998, 430.5, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 473.818176, 26.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 473.818176, 56.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "dump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 520.818176, 203.0, 50.5, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 464.818176, 203.0, 50.5, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 96.599998, 306.0, 302.5, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 34,
					"numoutlets" : 0,
					"patching_rect" : [ 96.599998, 393.5, 549.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 520.818176, 306.0, 151.0, 22.0 ],
					"saved_object_attributes" : 					{
						"active" : [ 1, 1, 1, 1 ],
						"aed_scale" : 10.0,
						"coord_angles" : 0,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 96.599998, 90.0, 231.0, 111.0 ],
					"relative" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 95.0, 24.0, 243.0, 22.0 ],
					"style" : "",
